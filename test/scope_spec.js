...
describe("Scope", function() {
	...
	describe("digest", function() {
		...
		it("canceled and flushes $applyAsync if digested first", function(done) {
		...
		if ("catches exceptions in watch functions and continues", function() {
				scope.aValue = 'abc';
				scope.counter = 0;
		...
		it("catches exceptions in listeren functions and countinues", function() {
			scope.aValue = 'abc';
			scope.counter = 0;
		...
		it("allows destroying a $watch a removal function", function() {
			scope.aValue = 'abc';
			scope.counter = 0;
		...
		it("allows destroying a $watch during the digest", function() {
			scope.aValue = 'abc';
		...
		it("allows destroying $watches during digest", function() {
			scope.aValue = 'abc';
			scope.counter = 0;
	...
	describe("inheritance", function() {
		...
		it("can manipulate a paren scope's property", function() {
			var parent = new Scope();
			var child = parent.$new();
		...
		it("can watch a propery in the parent", function() {
	...
	describe("$watchCollection", function() {
		...
		it("gives th eold array value to listeners", function() {
			scope.aValue = [1, 2, 3];
			var oldValueGiven;
	...
	describe("Events", function() {
		...
		_.forEach(['$emit', '$broadcast'], function(method) {
			...
			it("calls listener registered for matching events on " + method, function() {
		...
		it("is received by listener on current scope after being stopped", function() {
			var listener1 = function(event) {
				event.stopPropogation();
			};
